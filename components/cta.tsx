      ...
      <div className="grid w-full border border-b border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-700 dark:bg-gray-800 sm:grid-cols-3">
        <div className="mb-3 sm:col-span-2 sm:mb-0 sm:pr-0">
          <div className="flex justify-between items-center md:block">
            ...
            <Banner.CollapseButton
              color="gray"
              className="text-gray-400 border-0 bg-transparent px-0 sm:hidden [&>span]:px-2 enabled:hover:bg-gray-200 enabled:hover:text-gray-900 dark:enabled:hover:bg-gray-600 dark:enabled:hover:text-white"
            >
        ...
        <div className="flex justify-start sm:justify-end">
          <div className="flex items-center sm:space-x-4">
            ...
            <Banner.CollapseButton
              color="gray"
              className="hidden text-gray-400 border-0 bg-transparent px-0 sm:block [&>span]:px-2 enabled:hover:bg-gray-200 enabled:hover:text-gray-900 dark:enabled:hover:bg-gray-600 dark:enabled:hover:text-white"
            >
              <HiX className="h-5 w-5" />
            </Banner.CollapseButton>
          </div>

...
export const LightButton: React.FC<ButtonProps> = ({ href, text, target }) => (
  <Link
    href={href}
    target={target}
    className="border  border-gray-900 rounded-md backdrop-blur-lg bg-opacity-50 hover:bg-slate-50 hover:backdrop-blur-lg focus:ring-1 focus:ring-slate-400 enabled:hover:bg-slate-50 group relative px-5 py-2.5 transition-[color,background-color,border-color,text-decoration-color,fill,stroke,box-shadow] focus:z-10 focus:outline-none drop-shadow-sm"
  >

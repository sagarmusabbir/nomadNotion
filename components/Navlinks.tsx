  ...
  return (
    <nav>
      ...
      <ul
        className={`${
          isOpen ? "block" : "hidden"
        } md:flex md:space-x-4 absolute md:relative top-full  backdrop-blur-xl left-0 z-50 right-0 md:top-auto bg-slate-50 bg-opacity-50 md:bg-transparent shadow-md md:shadow-none pb-8 pt-4 md:pt-0 md:pb-0`}
      >
        {links.map((link) => {
          return (
